export default class View {
  ...
  renderStartScreen() {
    ...
    this.context.fillText('Press "Enter"', this.width / 2, this.height / 2 - 36);
    this.context.fillText('to play', this.width / 2, this.height / 2);
  }
  ...
  renderEndScreen({ score, hiscore }) {
    ...
    this.context.fillText('Press "Start"', this.width / 2, this.height / 2 + 46);
    this.context.fillText('to restart', this.width / 2, this.height / 2 + 82);
  }
  ...
  renderPanel({
    ...
    this.context.fillText(`High Score`, this.panelX, this.panelY + 5);
